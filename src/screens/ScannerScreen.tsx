  ...
  return (
    <View style={styles.container}>
      <View style={styles.webPicker}>
        ...
        <Text style={styles.webPickerTitle}>Seleccionar documento</Text>
        <Text style={styles.webPickerDesc}>
          Elige una imagen o PDF para analizar
        </Text>
...
export default function ScannerScreen({ navigation, route }: Props) {
  ...
  const processDocument = async ({ base64, mimeType }: { base64: string; mimeType: string }) => {
    ...
    setTimeout(() => navigation.replace('ContractResult', { result }), 1500);
  };
      ...
      <View style={[styles.permissionContainer, { backgroundColor: '#131313' }]}>
        <View style={[styles.permissionCard, { backgroundColor: '#1c1b1b' }]}>
          ...
          <Text style={styles.permissionDesc}>
            Necesitamos acceso a la cámara para escanear tus contratos
          </Text>
    ...
    <View style={styles.container}>
      ...
      <View style={StyleSheet.absoluteFill}>
        ...
        <View style={styles.helpPill}>
          <Text style={styles.helpText}>Encuadra el documento para escanear automáticamente</Text>
        </View>
      ...
      {showToast && (
        <Animated.View style={[styles.toast, { opacity: toastOpacity, transform: [{ scale: toastScale }] }]}>
          ...
          <Text style={styles.toastText}>Documento Capturado</Text>
        </Animated.View>
      )}
